  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../jenis/index.php">Link</a>
        </li>
...
<div class="container">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <a href="hapus.php?id_barang=<?php echo $result['id_barang'] ?>" onclick="return confirm('Kamu yakin mau hapus bray ?')" class="btn btn-danger"> Hapus<i class="fa-solid fa-trash"></i></a>
        </td>
      </tr>
      <?php
      $no++;
